    ...
    <div className="space-y-6">
      ...
      <Card variant="neutral" glow={true} padding="lg">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 relative z-10">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
               {workshopData?.logoPictureUrl && (
                  <div 
                     ...
                     className="w-20 h-20 bg-neutral-950 border border-neutral-800 rounded-[2rem] overflow-hidden shrink-0 shadow-2xl cursor-zoom-in hover:scale-105 active:scale-95 transition-all duration-300"
                  >
            ...
            <div className="bg-black/40 border border-white/10 px-8 py-4 rounded-2xl flex flex-col items-center shadow-lg shrink-0">
