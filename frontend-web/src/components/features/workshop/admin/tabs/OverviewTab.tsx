...
export const OverviewTab: React.FC<OverviewTabProps> = ({ workshopData, diasSemana }) => {
  return (
    <div className="space-y-6">
      {/* Workshop Profile Card */}
      <Card variant="red" glow={true} padding="lg">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 relative z-10">
            <div>
               ...
               <h2 className="text-3xl md:text-5xl font-black uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-neutral-500 mb-3 italic">{workshopData?.companyName}</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
         ...
         <Card variant="red" glow={true} padding="lg" className="lg:col-span-1">
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
               <div>
                  <p className="text-[10px] uppercase font-black tracking-[0.2em] text-red-500 mb-2 italic">Taller Activo</p>
                  <p className="text-7xl font-black text-white tracking-tighter drop-shadow-xl">{workshopData?.vehiclesCurrentCount || 0}</p>
               </div>
               <div className="mt-8">
                  <p className="text-sm font-black text-white tracking-widest uppercase italic">Vehículos</p>
         ...
         <div className="lg:col-span-3 flex flex-col gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <Card variant="neutral" padding="sm" className="h-[140px] flex flex-col justify-between hover:border-white/20">
                  ...
                  <div>
                     <p className="text-5xl font-black text-white italic tracking-tighter">{workshopData?.totalEmployees || 0}</p>
               ...
               <Card variant="neutral" padding="sm" className="h-[140px] flex flex-col justify-between hover:border-white/20">
                  ...
                  <div>
                     <p className="text-3xl font-black text-white font-mono tracking-tight">{workshopData?.openTime?.slice(0,5) || '--'} <span className="text-neutral-600 font-sans text-sm mx-1 italic">a</span> {workshopData?.closeTime?.slice(0,5) || '--'}</p>
            ...
            {/* Working Days Card */}
            <Card variant="neutral" padding="md" className="hover:border-white/20">
