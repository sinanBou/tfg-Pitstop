...
/**
 * Controlador REST para gestionar la autenticación e identidad del usuario.
 * Proporciona endpoints para verificación de cuenta, inicio de sesión con Google y recuperación de contraseñas.
 */
@RestController
