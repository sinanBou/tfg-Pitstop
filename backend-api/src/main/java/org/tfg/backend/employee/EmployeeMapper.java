...
/**
 * Componente encargado de realizar la conversión entre la entidad {@link Employee}
 * y su correspondiente Objeto de Transferencia de Datos (DTO) {@link EmployeeDTO}.
 */
@Component
