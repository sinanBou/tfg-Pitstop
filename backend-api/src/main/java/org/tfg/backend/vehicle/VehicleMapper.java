...
/**
 * Componente responsable de convertir las entidades {@link Vehicle}
 * en sus correspondientes DTOs detallados ({@link VehicleDTO}) o simplificados ({@link VehicleSearchDTO}).
 */
@Component
