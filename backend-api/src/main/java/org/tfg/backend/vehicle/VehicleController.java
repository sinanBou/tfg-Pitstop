...
/**
 * Controlador REST que expone endpoints para la gestión de vehículos.
 * Permite el registro de vehículos por clientes y personal, búsqueda por matrícula,
 * listado de vehículos del cliente autenticado y consulta del catálogo de marcas/modelos.
 */
@RestController
