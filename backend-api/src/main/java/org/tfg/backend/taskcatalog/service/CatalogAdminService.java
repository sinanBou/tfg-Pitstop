...
/**
 * Servicio administrativo para la creación, edición y borrado de tareas y categorías
 * del catálogo estándar del taller. Actúa como el soporte modular de lógica de escritura.
 */
@Service
