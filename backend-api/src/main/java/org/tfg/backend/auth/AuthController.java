...
public class AuthController {
    ...
    /**
    * Endpoint para autenticar a un usuario mediante sus credenciales (email y contraseÃ±a).
    *
    ...
    * @return ResponseEntity con mensaje informativo sobre la verificaciÃ³n por email.
    */
